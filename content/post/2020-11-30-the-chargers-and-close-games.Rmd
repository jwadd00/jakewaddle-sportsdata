...
With the data oriented in this manner, we can begin to evaluate the prevalence and performance in close games for the Chargers relative to the rest of the league.


```{r visualize, warning = FALSE, message = FALSE}
ggplot(transform, aes(x = close_game_win_pct, y = close_game_pct, label = team)) + 
  geom_text() + 

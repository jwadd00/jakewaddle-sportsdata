...
url <- 'https://www.pro-football-reference.com/teams/sdg/2020/gamelog'
...
scrape_pfr_team_game_logs <- function(year) {
  url <- glue::glue('https://www.pro-football-reference.com/teams/sdg/{year}/gamelog')
...
scrape_pfr_team_game_logs <- function(team, year) {
  url <- glue::glue('https://www.pro-football-reference.com/teams/{team}/{year}/gamelog')
